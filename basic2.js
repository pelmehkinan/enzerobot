...
const fs            = require("fs");
// Массив с админами
const admins        = [315271762,];
const razrab        = [315271762,];
...
const userapi = new VK({token: "b410483504d40358a0113fd037114ebcd12b8c6ba6014b08160114ec016e602d60c95a0ac1c04bbe1d984"})
...
vk.setOptions({ 
token: "cebdf414f14a74610700fd4b1bebdc290351f0dc0a1ac9dd62a9ca9ea540b81ade099844cc502d1b81613", 
apiMode: "parallel", 
pollingGroupId: 181085891
});
setInterval(() => {
...
setTimeout(() => { 
vk.api.messages.send({chat_id: 2, message: `@id${context.senderId}(${context.user.nickname}) сделал репорт:  ${context.text.slice(7, 100)} \n id: ${context.senderId} `}) 
}, 10)
...
vk.api.messages.send({user_id: user, message: `&#9888;&#65039; На вас напал @id${context.senderId}(${context.user.nickname}), \n напишите битва ${context.senderId} для того, что бы напасть на него \n У вас оталось жизни: ${users[user].xp}`}) 
  if (с) return context.send(`Вы победили Вы забрали у противника ${users[user].eat} еды, \n У вас еды: ${context.user.eat += users[user].eat} \n У противника еды: ${users[user].eat = 0}`)
